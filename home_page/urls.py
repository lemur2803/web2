...
urlpatterns = [
    ...
    url(r'^visits/(?P<ip_address>.+)$', 'home_page.views.details_page', name='details_page'),
    ...
    url(r'^gallery/statistic.xml$', 'home_page.views.statistic', name='get_statistic'),
    url(r'^gallery/get_history/$', 'home_page.views.get_history', name='get_history'),
]
